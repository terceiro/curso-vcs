...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/rcs-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/rcs-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/rcs-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/rcs-004.eps}}%
      \only<5>{\includegraphics[height=0.8\textheight]{figs/rcs-005.eps}}%
    \end{center}
    \label{fig:rcs}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/cvs-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/cvs-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/cvs-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/cvs-004.eps}}%
    \end{center}
    \label{fig:cvs}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[width=1\textwidth]{figs/centralized-interaction-001.eps}}%
      \only<2>{\includegraphics[width=1\textwidth]{figs/centralized-interaction-002.eps}}%
      \only<3>{\includegraphics[width=1\textwidth]{figs/centralized-interaction-003.eps}}%
      \only<4>{\includegraphics[width=1\textwidth]{figs/centralized-interaction-004.eps}}%
      \only<5>{\includegraphics[width=1\textwidth]{figs/centralized-interaction-005.eps}}%
      \only<6>{\includegraphics[width=1\textwidth]{figs/centralized-interaction-006.eps}}%
      \only<7>{\includegraphics[width=1\textwidth]{figs/centralized-interaction-007.eps}}%
      \only<8>{\includegraphics[width=1\textwidth]{figs/centralized-interaction-008.eps}}%
    \end{center}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/svn-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/svn-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/svn-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/svn-004.eps}}%
    \end{center}
    \label{fig:svn}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/distributed-vcs-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/distributed-vcs-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/distributed-vcs-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/distributed-vcs-004.eps}}%
    \end{center}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \includegraphics[width=1.0\textwidth]{figs/evolucao.eps}
    \end{center}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/git-branch-merge-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/git-branch-merge-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/git-branch-merge-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/git-branch-merge-004.eps}}%
      \only<5>{\includegraphics[height=0.8\textheight]{figs/git-branch-merge-005.eps}}%
      \only<6>{\includegraphics[height=0.8\textheight]{figs/git-branch-merge-006.eps}}%
      \only<7>{\includegraphics[height=0.8\textheight]{figs/git-branch-merge-007.eps}}%
    \end{center}
    \label{fig:git-branch-merge}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/git-fast-forward-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/git-fast-forward-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/git-fast-forward-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/git-fast-forward-004.eps}}%
      \only<5>{\includegraphics[height=0.8\textheight]{figs/git-fast-forward-005.eps}}%
    \end{center}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/git-rebase-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/git-rebase-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/git-rebase-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/git-rebase-004.eps}}%
      \only<5>{\includegraphics[height=0.8\textheight]{figs/git-rebase-005.eps}}%
      \only<6>{\includegraphics[height=0.8\textheight]{figs/git-rebase-006.eps}}%
      \only<7>{\includegraphics[height=0.8\textheight]{figs/git-rebase-007.eps}}%
    \end{center}
    \label{fig:rebase}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/central-repository-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/central-repository-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/central-repository-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/central-repository-004.eps}}%
      \only<5>{\includegraphics[height=0.8\textheight]{figs/central-repository-005.eps}}%
      \only<6>{\includegraphics[height=0.8\textheight]{figs/central-repository-006.eps}}%
    \end{center}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/integration-manager-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/integration-manager-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/integration-manager-003.eps}}%
    \end{center}
...
\begin{frame}
  ...
  \begin{figure}[h]
    \begin{center}
      \only<1>{\includegraphics[height=0.8\textheight]{figs/dictator-and-lieutenants-001.eps}}%
      \only<2>{\includegraphics[height=0.8\textheight]{figs/dictator-and-lieutenants-002.eps}}%
      \only<3>{\includegraphics[height=0.8\textheight]{figs/dictator-and-lieutenants-003.eps}}%
      \only<4>{\includegraphics[height=0.8\textheight]{figs/dictator-and-lieutenants-004.eps}}%
    \end{center}
